...
@Embeddable
public class ItemPedidoPKDomain implements Serializable {

	private static final long serialVersionUID = -7319010669892266600L;
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		ItemPedidoPKDomain other = (ItemPedidoPKDomain) obj;
		if (pedido == null) {
